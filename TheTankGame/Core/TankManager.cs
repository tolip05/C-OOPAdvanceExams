namespace TheTankGame.Core
{
    ...
    public class TankManager : IManager
    {
        ...
        public TankManager(IBattleOperator battleOperator, IVehicleFactory vehicleFactory
        ...
        public string AddVehicle(IList<string> arguments)
        {
            ...
            IVehicle vehicle = this.vehicleFactory.CreateVehicle(vehicleType,model,
        ...
        {
       //   Destroyer-2U Arsenal Cannon-X 1000 50000 5000
            ...
            //        break;
            //}
            this.parts.Add(part.GetType().Name,part);
        ...
        public string Inspect(IList<string> arguments)
        {
            ...
            {
                if (item.Value.Model.ToString() == model)
                {
                    return this.vehicles[item.Key].ToString();
                }
            }
